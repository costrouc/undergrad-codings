function [localmat] = d1_ip_Dten0_Dten0(isub, quad_rul, ...
   scal_fun, ten0a_type, ten0b_type) 
%
% This function computes, for subinterval isub, the integrals
% of the (scalar) derivative of ten0a basis functions times 
% the (scalar) derivative of ten0b basis functions multiplied by the scalar
...
for iq = 1:nqpts
   Gradten0a(:,iq) = quad_wghts(iq) * sfun_vals(iq) * Gradten0a(:,iq) ;  
end

mat1 = Gradten0a * Gradten0b.' ;
